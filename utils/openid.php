...
class LightOpenID
{
    ...
    protected function authUrl_v2($immediate)
    {
        ...
        if (!empty($this->oauth) && is_array($this->oauth)) {
            ...
            $params['openid.oauth.consumer'] = str_replace(
                array('http://', 'https://'),
                '',
                $this->trustRoot
            );
     ...
     * @param String $select_identifier Whether to request OP to select identity for an user in
                        OpenID 2. Does not affect OpenID 1.
     * @throws ErrorException
     */
     ...
     * Note that it does not guarantee that any of the required/optional parameters will be
                            present,
